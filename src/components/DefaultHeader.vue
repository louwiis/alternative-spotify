...
<template>
  <header
    class="flex flex-row items-center justify-between px-8 py-[12px] shrink-0"
  >
    <div class="flex gap-3 items-center">
      ...
      <div v-if="store.pageName == 'search'">
        <input
          ...
          class="w-[364px] rounded-full px-[40px] py-[10px] placeholder:text-gray-500 text-sm"
    ...
    <div
      v-if="userProfile"
      class="text-white flex flex-row items-center gap-2 bg-black rounded-3xl p-[2px] w-[180px]"
    >
      <div
    ...
    <div v-else>
      <a
        href="/login"
        class="text-white bg-black rounded-full px-[20px] py-[10px] text-sm"
        >Login</a
      >
    </div>
  </header>
